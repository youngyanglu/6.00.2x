...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        a=math.floor(pos.x)
        b=math.floor(pos.y)
        if (a,b) not in self.cleaned:
            self.cleaned.append((a,b))
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return int(math.floor(self.height)*math.floor(self.width))
    ...
    def isPositionInRoom(self, pos):
        ...
        if type(pos) is tuple:
            if pos[1]>=0 and pos[1] <self.width:
                if pos[2]>=0 and pos[2]<self.height:
                    return True
            else:
                return False
