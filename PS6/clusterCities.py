...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        newpoints=c1.points + c2.points
        newCluster=Cluster(newpoints, c1.pointType)
        self.add(newCluster)
    ...
    def findClosest(self, linkage):
        ...
        for i in self.members:
            for j in self.members:
                if i!=j:
                    if linkage(i,j)<shortest:
                        closest=(i,j)
                        shortest=linkage(i,j)
        return closest 
